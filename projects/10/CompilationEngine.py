...
class CompilationEngine:
    ...
    def write_current_token(self) -> None:
        ...
        self.output_stream.write(f"<{tag}> {escaped_val} </{tag}>\n") # or corresponding tag
    ...
    def compile_statements(self) -> None:
        ...
        while self.input_stream.token_type() == TokenType.KEYWORD and self.input_stream.keyword() in ['let', 'if', 'while', 'do', 'return']:
    ...
    def compile_return(self) -> None:
        ...
        if not (self.input_stream.token_type() == TokenType.SYMBOL and self.input_stream.symbol() == ';'):
            self.compile_expression()
        self.write_current_token() # ';'
        self.output_stream.write("</returnStatement>"+ "\n")
        return
